...
List of files: 
	...
	025mgLTricRep1.insert_site_ploti.gz 025mgLTricRep2.insert_site_plot.gz - condition plot files (0.25mg/L triclosan concentration)
Example command to run albatradis:

albatradis -v -a W25113 Genome annotation 025mgLTricRep1.insert_site_plot.gz 025mgLTricRep2.insert_site_plot.gz controlLBrep1.insert_site_plot.gz controlLBrep1.insert_site_plot.gz
