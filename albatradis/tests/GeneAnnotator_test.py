...
class TestGeneAnnotator(unittest.TestCase):
    ...
    def test_fabI(self):
        ...
        self.assertEqual(1, len(genes))
        self.assertEqual(
            'fabI	upregulated	1344507	1345296	10	xx	reverse	yciW__3prime	0.0	0.0',
            str(genes[0]))
    ...
    def test_increased_neg(self):
        ...
        genes = a.annotate_genes()
        self.assertEqual(
            "1_100	decreased_mutants_at_end_of_gene	0	100	10.0	increased_insertions	reverse	NA	0.0	0.0",
            str(genes[0]))
    ...
    def test_downregulated_neg(self):
        ...
        genes = a.annotate_genes()
        self.assertEqual(
            "1_100	decreased_mutants_at_end_of_gene	0	100	-10.0	decreased_insertions	reverse	NA	0.0	0.0",
            str(genes[0]))
    ...
    def test_increased_knockout(self):
        ...
        genes = a.annotate_genes()
        self.assertEqual(
            "cyaA	knockout	3984512	3987059	10	increased_insertions	forward	yifL	0.0	0.0",
            str(genes[0]))
